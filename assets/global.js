...
//     console.log(this.currentVariant.featured_media.preview_image.src);
        const thumbImg = (this.currentVariant.featured_media.position);
		const PositionImg = thumbImg - 1;
//     	console.log(PositionImg);
    $(".slide_nav_main[data-slick-index='"+ PositionImg +"']").click();
